    ...
    return (
        <div className="container mt-4">
            ...
            <div className="row container mt-4">
                ...
                <div className="col-md-6 col-sm-12">
                    <img className="img-width" src={img1} alt="img"/>
                </div>
            </div>
            <div className="row flex mt-4">
                <div className="col-md-6 col-sm-12">
                    <img className="img-width" src={img2} alt="img"/>
                </div>
                <div className="col-md-6 col-sm-12">
            ...
            <div className="row flex mt-4">
                ...
                <div className="col-md-6 col-sm-12">
                    <img className="img-width" src={img3} alt="img"/>
                </div>
            </div>
            <div className="row flex mt-4">
                 <div className="col-md-6 col-sm-12">
                    <img className="img-width" src={img4} alt="img"/>
                </div>
                <div className="col-md-6 col-sm-12">
