...
export default function Navbar() {
    return (
        <div className="mt-3 container">
            <p className="mx-2">186, Awolowo Road, Ikoyi - Lagos <span className="mx-2">info@donnettebdc.com</span><span className="mx-2 p-2" style={{background: '#B2417B', borderRadius: '20px', color: '#fff'}}>08142703957; 08139308681</span></p>
